...
public class ListSektorListener implements RecyclerView.OnItemTouchListener {
    ...
    public ListSektorListener(Context context, final RecyclerView recyclerView, ClickListener listener) {
